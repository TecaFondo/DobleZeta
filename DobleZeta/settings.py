"""
Django settings for DobleZeta project.
...
SECRET_KEY = 'django-insecure-k#mokc##a)1-wlh(-lvmd7ea-$!cxbo3u76b%m@8u%zh^do74f'
...
ROOT_URLCONF = 'DobleZeta.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'restaurant/templates/restaurant'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'DobleZeta.wsgi.application'
